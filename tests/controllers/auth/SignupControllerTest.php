 ...
 *
 * Unit tests for the SignupController.
 * Verifies user creation logic via the POST method.
 *
...
class SignupControllerTest extends TestCase
{
    ...
    /**
     * Tests valid user creation via POST.
     *
     * @covers ::post
     * @return void
     */
    ...
    /**
     * Tests creation failure if the email format is invalid.
     *
     * @covers ::post
     * @return void
     */
    ...
    /**
     * Tests creation failure if no profession is selected.
     *
     * @covers ::post
     * @return void
     */
