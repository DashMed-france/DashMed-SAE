...
require_once __DIR__ . '/../../../tests/mocks/views/pages/ProfileView.php';
...
class ProfileControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec(
            "INSERT INTO professions (label_profession) VALUES ('Cardiologue'), ('Dermatologue')"
        );
        $this->pdo->exec("
        ...
        $this->controller = new ProfileController($this->pdo);
