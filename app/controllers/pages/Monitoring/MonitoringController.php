...
class MonitoringController
{
    ...
    public function get(): void
    {
        try {
            ...
            $processedMetrics = $this->processMetrics($metrics, $rawHistory, $prefs);
     ...
     */
    private function processMetrics(array $metrics, array $rawHistory, array $prefs): array
    {
     ...
     */
    private function calculatePriority(array $m): int
    {
     ...
     */
    private function prepareViewData(array $row): array
    {
        $viewData = [];
