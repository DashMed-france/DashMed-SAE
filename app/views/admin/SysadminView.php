            ...
            <main class="container nav-space">
                <section class="dashboard-content-container">
                    ...
                    <div class="section-switcher">
                        ...
                        <button type="button" class="section-switcher-btn" data-target="panel-patient" id="tab-patient">
                            <svg viewBox="0 0 24 24">
                                <path
                    ...
                    <div class="section-panel active" id="panel-comptes">
                        <div class="admin-grid">
                            ...
                            <div class="sysadmin-card">
                                ...
                                <p id="no-profile-results" class="no-profiles" style="display:none;">Aucun profil correspondant.
                                </p>
                                ...
                                <div id="edit-section" class="edit-inline-section" style="display:none;">
                                    ...
                                    <form action="?page=sysadmin" method="POST" id="edit-form" novalidate>
                                        ...
                                        <div class="edit-inline-actions">
                                            <button type="button" class="submit-btn edit-cancel-btn"
                                                id="edit-cancel">Annuler</button>
                        ...
                        <div class="section-panel" id="panel-patient">
                            <div class="admin-grid" style="display: flex; justify-content: center;">
                                <div class="sysadmin-card" style="width: 100%; max-width: 650px;">
