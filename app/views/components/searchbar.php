...
<form class="searchbar" role="search" action="#" method="get">
    ...
    <div class="actions">
        ...
        <div class="profile-menu" id="profileMenu" role="menu">
                ...
                <div class="switch">
                    <div class="thumb">
                        ...
                        <svg class="sun" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <path
                                d="M12 1v2m0 18v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2m18
                                0h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"
            ...
            <a class="menu-items" role="menuitem" href="/?page=customization">Personnalisation</a>
