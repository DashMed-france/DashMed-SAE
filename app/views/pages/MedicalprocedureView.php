...
class MedicalprocedureView
{
     ...
     *
     * @param array<int, \modules\models\Consultation> $consultations Consultation objects | Objets Consultation.
            ...
            <main class="container nav-space">
                ...
                <section class="dashboard-content-container">
                    ...
                    <input type="hidden"
                           ...
                           value="<?= htmlspecialchars((string) $this->patientId) ?>"
                    >
                        ...
                        <?php if (!empty($this->consultations)) : ?>
                            <?php foreach ($this->consultations as $consultation) :
                                ...
                                <article class="consultation"
                                         id="consultation-<?php echo $consultation->getId(); ?>" data-date="<?php
