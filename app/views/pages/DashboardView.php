 ...
 * Contains key patient indicators, a search bar, and lateral components
 * such as the sidebar and the calendar.
 *
 ...
 * Dashboard View.
 *
 * Main entry point for authenticated doctors. This view aggregates
 * vital indicators, upcoming/past consultations, and room selection management.
 *
 * @package modules\views\pages
 */
class DashboardView
{
    /** @var array List of completed consultations. */
    private $consultationsPassees;

    /** @var array List of future consultations. */
    private $consultationsFutures;

    /** @var array List of rooms with associated patients. */
    private array $rooms;

    /** @var array Vital metrics of the selected patient. */
    private array $patientMetrics;

    /** @var array Administrative data of the selected patient. */
    private array $patientData;

    /** @var array Chart types configuration. */
    private array $chartTypes;

    /**
     * Initializes the dashboard with the full contextual data set.
     *
     * @param array $consultationsPassees Consultation history.
     * @param array $consultationsFutures Upcoming appointments.
     * @param array $rooms                List of occupied rooms.
     * @param array $patientMetrics       Real-time/historical health data.
     * @param array $patientData          Patient info (identity, age, reason).
     * @param array $chartTypes           Visualizations configuration.
     */
     ...
     *
     * Includes the sidebar, top search bar, patient info panel,
    ...
    public function show(): void
    {
        ...
        <head>
            ...
            <meta name="description" content="Private dashboard for doctors, accessible only to authenticated users.">
