...
final class CustomizationView
{
     ...
     *
     * @param array<int, array{id: string, name: string, category: string, x: int, y: int, w: int, h: int}> $widgets
     * @param array<int, array{id: string, name: string}> $hidden
     */
                                            ...
                                            <div class="dm-widget">
                                                <div class="dm-widget-header">
                                                    ...
                                                    <div class="dm-widget-controls">
                                                        <span class="dm-widget-grip" title="Déplacer"><svg viewBox="0 0 24 24"
                                                        ...
                                                        <button type="button" class="dm-widget-hide" title="Masquer"><svg
