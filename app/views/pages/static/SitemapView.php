...
class SitemapView
{
    ...
    public function show(): void
    {
        ...
        <head>
            ...
            <meta name="description" content="Retrouvez toutes les pages de DashMed ici.">
        ...
        <body>
            ...
            <main class="container homepage-container">
                <section class="hero">
                    <h1 class="title">
                        <span class="text-dark">Plan du</span> <span class="text-primary">site</span>
                    </h1>
                </section>

                <section class="sitemap-content">
                    <article class="sitemap-category">
