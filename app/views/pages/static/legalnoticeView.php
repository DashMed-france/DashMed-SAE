<?php
/**
 * DashMed — Legal Notice View
 *
 * Displays the legal information regarding the publisher, host, and terms of use.
 *
...
/**
 * Displays the legal notice page for DashMed.
 *
 * Responsibilities:
 * - Show mandatory legal information (editor, host, contact, credits).
 */
class LegalnoticeView
{
    /**
     * Displays the legal notice HTML content.
     *
     * @return void
     */
    public function show(): void
    {
        ...
        <head>
            <meta charset="UTF-8">
            <title>DashMed - Legal Notice</title>
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <meta name="description"
                  content="DashMed legal notices: information about the publisher, the host and the terms of use of the site.">
            <meta name="keywords" content="legal notice, dashmed, terms, hosting, contact, dashmed team">
