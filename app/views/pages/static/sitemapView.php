<?php
/**
 * DashMed — Sitemap View
 *
 * Displays the sitemap to improve navigation and search engine optimization (SEO).
 *
 ...
 *
 * Responsibilities:
 * - Display a sitemap for SEO and ease of navigation.
 */
class SitemapView
{
    /**
     * Displays the sitemap page HTML content.
     *
     * @return void
     */
    public function show(): void
    {
        ...
        <head>
            <meta charset="UTF-8">
            <title>DashMed - Sitemap</title>
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <meta name="description" content="Find all the pages of our site here.">
            <meta name="keywords" content="sitemap, navigation, dashmed, health, doctors, patients">
