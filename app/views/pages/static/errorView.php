...
/**
 * DashMed — Error Page View
 *
 * Displays the error page providing a more elegant interface as well as
 * information about the various issues encountered.
 *
...
/**
 * Displays the DashMed platform error page.
 *
 * Responsibilities:
 * - Display and control potential errors the application might encounter.
 *
 */
...
class ErrorView
{
    public function show(
        ...
        /**
         * Generates the error page HTML structure.
         *
         * Includes the possibility to show the error log if the application is in a development environment.
         * Takes the error code, error message, and technical details as parameters.
         *
         * @return void
         */
        ...
        <svg width="100%" viewBox="0 0 1920 241" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path class="wave" style="transform: translateY(+20px)"
                  d="M1920 208.188L1880 191.782C1840 175.375 1760 142.563 1680 131.592C1600 121.03 1520 131.284 1440 109.751C1360 88.2179 1280 32.8472 1200 11.3142C1120 -10.2189 1040 0.0349719 960 33.1548C880 65.6595 800 121.03 720 137.129C640 153.842 560 131.284 480 137.129C400 142.563 320 175.375 240 169.941C160 164.096 79.9999 121.03 39.9999 98.7794L-5.72205e-05 76.9387V241H39.9999C79.9999 241 160 241 240 241C320 241 400 241 480 241C560 241 640 241 720 241C800 241 880 241 960 241C1040 241 1120 241 1200 241C1280 241 1360 241 1440 241C1520 241 1600 241 1680 241C1760 241 1840 241 1880 241H1920V208.188Z"
                  fill="#275AFE" />
        </svg>
        </body>
